...
public class VisualizzaNotaActivity extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_visualizza_nota);
        CounterSingleton nomePaziente = CounterSingleton.getInstance();
        String nome = leggiDatiDaFile(nomePaziente.getBambinoSelezionato());
        mostraDialog(nome);
    ...
    private String leggiDatiDaFile(String nome) {
        ...
        try {
            ...
            File file = new File(bambinoDir, "note.txt"); // Nome fisso del file dei dati
